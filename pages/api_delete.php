...
if(!IdExists($ApiId,'api_collector')){
...
if(!empty($_POST)) {
	...
	if(!Token::check($token)){
		...
		if (!empty($_POST['delete'])){
			$db = DB::getInstance();
			$query="DELETE FROM api_collector WHERE  id ='".$ApiId."'";
			echo $query;
	...
	<main role="main">
		<section class="section section-full ">
			<div class="container-fluid">
				<div class="pagina">
				    <div class="page-title pb-2">Admin - Api-Collector - delete </div>
					<div class="col-12">
						<div class="row">
							<form class="form-signup col-10" action="" method="POST" id="payment-form">
								...
								<div class="card-body p-3">
									...
									<div class="row">
										<a class="btn btn-secondary mx-2" href="api_collector.php">Cancel / return to overview</a>
									</div>										
								</div>	
							</form>													
						</div>
