...
$lang = array_merge($lang,array(
	...
	"MENU_PLAN_Drivers"     => "drivers",
	"MENU_PLAN_Del_Contacts"=> "delivery contacts",
	"MENU_RES_VEHICLES"	    => "vehicles",
	"MENU_RES_DRIVERS"      => "drivers",
	"MENU_RES_TRAILERS"	    => "trailers",
	"MENU_RES_GROUPS"  	    => "groups",
	"MENU_RES_DEALERS"	    => "workshops",
	"MENU_Rep_Trips"   	    => "trips",
	"MENU_Rep_TripAnalysis" => "trip analysis",
	"MENU_Rep_TripAnalysisAdd"   => "showing trip data for selected vehicle",
	"MENU_Rep_PDC"   	    => "vehicle Pre-Departure-Checks",
	"MENU_Rep_AHistory"   	=> "alert history",
	"MENU_Rep_AAnalysis"    => "alert analysis",
	...
	"MENU_Tools_StartPDC"   => "perform PreDeparture Check",
