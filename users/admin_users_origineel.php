...
?>
	...
	<main role="main">
				    ...
				    <div class="col-12 col-md-4">
					   ...
					   <?php if (!$form_valid && Input::exists()){echo display_errors($validation->errors());}   ?>
						<form class="form-signup" action="admin_users.php" method="POST" id="payment-form">
							...
							<a href="admin_pages.php"><button type="submit" class="btn btn-primary" >return to Page Admin</button></a>
						</form>
					</div>	
					<div class="col-md-8">
						<div class="card">
							...
							<div class="card-body">
								...
								<table id="tableAdminUsers" class="table col-12">
									<thead>
										<tr>
										<th ></th>
										<th >Username</th>
		...
		<div class="modal fade modal-center" id="modal-newuser" tabindex="-1" role="dialog" aria-labelledby="NewUser" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content bg-white">
					<div class="modal-header">
						<h3 class="modal-title"><b>New User</b></h3>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					</div>					
					<div class="modal-body">
						<div class="col-3">
							<div class=""><img src="<?=$us_url_root?>images/favicon.png" class="aboutlogo" ></div>
						</div>
						<div class="col-12 p-2 modal-about">
							<p>Licensed to:<b> DAF Trucks NV / DAF Connect</b><p>
							<p>version :<b> 8.11b </b><p>
							<p>rFMS Connect is a basic fleetmanagement product by collecting vehicle data via a REST-API based on the rFMS-standard. <br/>The rFMS standard is created to exchange FMS-vehicle data between truck manufacturers and Telematics Solution Providers</p>
							<p>This application is used to visualise the rFMS-data from DAF Connect and has multiple modules and be easily extended with new features</p>							
						</div>
					</div>	
					<div class="border-top p-2">
						<img class="text-left" src="<?=$us_url_root?>images/ilionx-logo.svg" heigth="20px"> <small> Copyright &copy;  Peter Aarts 2019 &nbsp </small>							
					</div>							
				</div>
			</div>
		</div>
...
<!--<script src="<?=$us_url_root?>bootstrap/js/bootstrap-table.js"></script>
<script src="<?=$us_url_root?>bootstrap/js/bootstrap-table-en-US.js"></script>
<script src="<?=$us_url_root?>bootstrap/js/tableExport.js"></script>
<script src="<?=$us_url_root?>bootstrap/js/bootstrap-table-export.js"></script>-->
