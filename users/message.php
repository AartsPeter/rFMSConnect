...
//PHP Goes Here!
?>
<div class="content-wrapper" id="messagPage">
    <section class="content-header">
		<h2>Mailbox <small></small></h2>
		<ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li>Administration</li>
        <li class="active">See all your messages</li>
    </section>
					  ...
					  <?php }else{ ?>
								<li class="left clearfix">
									...
									<div class="chat-body clearfix">
										...
										<p>
										<br>
										<?php $msg = html_entity_decode($m->msg_body);echo $msg; ?>
										</p>
									</div>
								</li>
